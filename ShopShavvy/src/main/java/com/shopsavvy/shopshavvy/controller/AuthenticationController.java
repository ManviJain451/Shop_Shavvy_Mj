...
public class AuthenticationController {
    ...
    public ResponseEntity<SuccessMessageResponse<String>> resendActivationLink(@Valid @RequestParam EmailDTO emailDTO) throws Exception {
    ...
    public ResponseEntity<SuccessMessageResponse<String>> forgotPassword(@Valid @RequestParam EmailDTO emailDTO) throws MessagingException {
